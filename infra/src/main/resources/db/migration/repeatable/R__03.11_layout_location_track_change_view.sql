...
select
  ...
  location_track_version.naming_scheme,
  location_track_version.name_free_text,
  location_track_version.name_specifier,
  ...
  location_track_version.version,
      ...
      over (partition by location_track_version.id, design_id order by location_track_version.version) as old_state
