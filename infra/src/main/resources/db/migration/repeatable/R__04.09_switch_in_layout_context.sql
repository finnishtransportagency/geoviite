...
drop function if exists layout.switch_is_in_layout_context(layout.publication_state, int, layout.switch);

create function layout.switch_is_in_layout_context(publication_state_in layout.publication_state, design_id_in int,
                                                   row_in layout.switch) returns boolean
  language sql as
$$
select
...
select
  ...
  where layout.switch_is_in_layout_context(publication_state_in, design_id_in, row)
$$;
