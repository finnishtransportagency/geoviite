...
const val EXT_LOCATION_TRACKS_TAG_V1 = "Sijaintiraiteet"
...
class ExtLocationTrackControllerV1(
    ...
    fun getExtLocationTrack(
        ...
        extLocationTrackService.getExtLocationTrack(oid, layoutVersion, coordinateSystem).let(::toResponse)
    ...
    fun getExtLocationTrackModifications(
        ...
        extLocationTrackService
            .getExtLocationTrackModifications(oid, layoutVersionFrom, layoutVersionTo, coordinateSystem)
            .let(::toResponse)
    ...
    @ApiResponses(
        value =
            [
                ApiResponse(responseCode = "200", description = "Sijaintiraiteen geometrian muutosten haku onnistui."),
                ApiResponse(
                    responseCode = "204",
                    description =
                        "Sijaintiraiteen OID-tunnus löytyi, mutta geometrian muutoksia vertailtavien versioiden välillä ei ole.",
                    content = [Content(schema = Schema(hidden = true))],
                ),
                ApiResponse(
                    responseCode = "400",
    ...
    fun getExtLocationTrackGeometryModifications(
        ...
        extLocationTrackGeometryService
            .getExtLocationTrackGeometryModifications(
                oid,
                layoutVersionFrom,
                layoutVersionTo,
                extResolution,
    ...
    @ApiResponses(
        value =
            [
                ApiResponse(responseCode = "200", description = "Sijaintiraiteen pystygeometrian haku onnistui."),
                ApiResponse(
                    responseCode = "204",
                    description =
    ...
    fun getExtLocationTrackProfile(
        ...
        @RequestParam(COORDINATE_SYSTEM, required = false)
        extCoordinateSystem: ExtSridV1? = null,
    ): ResponseEntity<ExtLocationTrackProfileResponseV1> =
        extLocationTrackProfileService
            .getExtLocationTrackProfile(oid, layoutVersion, extCoordinateSystem)
            .let(::toResponse)
    ...
    @ApiResponses(
        value =
            [
                ApiResponse(
                    responseCode = "200",
                    description = "Sijaintiraiteen pystygeometrian muutosten haku onnistui.",
                ),
                ApiResponse(
                    responseCode = "204",
                    description = EXT_OPENAPI_NO_MODIFICATIONS_BETWEEN_VERSIONS,
