...
class ExtSwitchControllerV1(private val extSwitchService: ExtSwitchServiceV1) {
    ...
    fun getExtSwitchCollection(
        ...
        @Parameter(description = "Suodatus vaihdetunnuksen osalla (kirjainkoko ei merkitse)")
        @RequestParam(SWITCH_NAME, required = false)
        switchNameFilter: String?,
    ): ExtSwitchCollectionResponseV1 = extSwitchService.getExtSwitchCollection(layoutVersion, extCoordinateSystem, switchNameFilter)
    ...
    fun getExtSwitchCollectionModifications(
        ...
        extSwitchService
            .getExtSwitchCollectionModifications(layoutVersionFrom, layoutVersionTo, extCoordinateSystem, switchNameFilter)
            .let(::toResponse)
