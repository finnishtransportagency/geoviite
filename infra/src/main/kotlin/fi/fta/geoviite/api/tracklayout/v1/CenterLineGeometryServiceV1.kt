...
//
//        // TODO Supporting the custom interval in this will require a bunch of work due to address point interval
// being
//        // in 1 meter in the cache.
//        //
//        // TODO This will require even more work due to having to get the differing address points based on the
// specific
...
//
//        val versionAtMoment = locationTrackDao.fetchOfficialVersionAtMoment(LayoutBranch.main, locationTrackId,
// moment)
//
...
//        //                    changedGeometryRanges.added.firstOrNull { range -> addressPoint.point.m in
//        // range.min..range.max }
//        //                }
//        //                .filterKeys { it != null }
...
//        //                        addressPoints = intervalAddressPoints.map(ExtAddressPointV1::of),
//        //                    )
//        //
//        //                    // TODO
...
//        //                val startAddress =
//        //                    geocodingService.getAddress(mainOfficial, request.locationTrack.trackNumberId,
//        // trackMeterRange.min)
//        //
//        //                val endAddress =
//        //                    geocodingService.getAddress(mainOfficial, request.locationTrack.trackNumberId,
...
//    //                mergedIntervals.add(
//    //                    ExtTrackInterval(Range(requireNotNull(tempIntervalStartM), event.trackM),
...
//    //                        ?.let { startM ->
//    //                            mergedIntervals.add(ExtTrackInterval(Range(startM, event.trackM),
//    // tempIntervals[0].type))
//    //                        }
//    //
...
//    //                    tempIntervalStartM = event.trackM
//    //                } else {
//    //                    // This interval type was not prioritized, but it ended while overlapped by another
// interval.
...
//        else -> {
//            try {
//                val convertedPoint = transformNonKKJCoordinate(LAYOUT_SRID, targetCoordinateSystem,
// addressPoint.point)
...
//                endAddress = alignmentAddresses.endPoint.address.toString(),
//                addressPoints = convertedMidPoints?.map(ExtAddressPointV1::of) ?: emptyList(),
//            )
//        )
//
