...
data class ExtSwitchV1(
    ...
    @Schema(example = "1") @JsonProperty(PRESENTATION_JOINT_NUMBER) val presentationJointNumber: Int,
    @JsonProperty(STATE_CATEGORY) val stateCategory: ExtSwitchStateV1,
    @Schema(type = "string", example = "Väylävirasto") @JsonProperty(OWNER) val owner: MetaDataName,
