...
// * @property changesAfterTimestamp Timestamp filter. The response data will only include geometry changes which
// occurred
// *   after the provided timestamp. If the timestamp filter is not provided, the response will include the entire
// current
