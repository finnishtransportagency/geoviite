 ...
 */
fun angleAvgRads(rads1: Double, rads2: Double): Double =
...
sealed class Angle {
    ...
    /**
     * Turns an angle from typical math representation (0=positive-X & growing counter-clockwise)
     * into a typical geodetic representation (0=North & growing clockwise).
     */
