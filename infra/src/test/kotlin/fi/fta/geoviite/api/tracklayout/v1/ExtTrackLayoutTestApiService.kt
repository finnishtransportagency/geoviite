...
class ExtTrackLayoutTestApiService(mockMvc: MockMvc) {
    ...
    val designs =
        AssetApi<Oid<*>, ExtTestDesignResponseV1, ExtTestModifiedDesignResponseV1>(
            assetUrl = { oid -> "/geoviite/paikannuspohja/v1/suunnitelmat/${oid}" },
            assetClazz = ExtTestDesignResponseV1::class,
            modifiedUrl = { oid -> "/geoviite/paikannuspohja/v1/suunnitelmat/${oid}/muutokset" },
            modifiedClazz = ExtTestModifiedDesignResponseV1::class,
        )

    val designCollection =
        AssetCollectionApi(
            assetCollectionUrl = { "/geoviite/paikannuspohja/v1/suunnitelmat" },
            assetCollectionClazz = ExtTestDesignCollectionResponseV1::class,
            modifiedAssetCollectionUrl = { "/geoviite/paikannuspohja/v1/suunnitelmat/muutokset" },
            modifiedAssetCollectionClazz = ExtTestModifiedDesignCollectionResponseV1::class,
        )
    ...
    val locationTrackProfile =
        AssetApi<Oid<*>, ExtTestLocationTrackProfileResponseV1, ExtTestModifiedLocationTrackProfileResponseV1>(
            ...
            modifiedUrl = { oid -> "/geoviite/paikannuspohja/v1/sijaintiraiteet/${oid}/pystygeometria/muutokset" },
            modifiedClazz = ExtTestModifiedLocationTrackProfileResponseV1::class,
        )

    val locationTrackElementListing =
        AssetApi<
            Oid<*>,
            ExtTestLocationTrackElementListingResponseV1,
            ExtTestLocationTrackElementListingModificationsResponseV1,
        >(
            assetUrl = { oid -> "/geoviite/paikannuspohja/v1/sijaintiraiteet/${oid}/geometriaelementit" },
            assetClazz = ExtTestLocationTrackElementListingResponseV1::class,
            modifiedUrl = { oid -> "/geoviite/paikannuspohja/v1/sijaintiraiteet/${oid}/geometriaelementit/muutokset" },
            modifiedClazz = ExtTestLocationTrackElementListingModificationsResponseV1::class,
        )
    ...
    val trackNumberGeometry =
        AssetApi<Oid<*>, ExtTestTrackNumberGeometryResponseV1, ExtTestModifiedTrackNumberGeometryResponseV1>(
            ...
            modifiedUrl = { oid -> "/geoviite/paikannuspohja/v1/ratanumerot/${oid}/geometria/muutokset" },
    ...
    fun locationTrackElementListingInDesign(designOid: Oid<*>) =
        AssetApi<
            Oid<*>,
            ExtTestLocationTrackElementListingResponseV1,
            ExtTestLocationTrackElementListingModificationsResponseV1,
        >(
            assetUrl = { oid ->
                "/geoviite/paikannuspohja/v1/suunnitelmat/${designOid}/sijaintiraiteet/${oid}/geometriaelementit"
            },
            assetClazz = ExtTestLocationTrackElementListingResponseV1::class,
            modifiedUrl = { oid ->
                "/geoviite/paikannuspohja/v1/suunnitelmat/${designOid}/sijaintiraiteet/${oid}/geometriaelementit/muutokset"
            },
            modifiedClazz = ExtTestLocationTrackElementListingModificationsResponseV1::class,
        )
