...
constructor(
    ...
    private val errorTests =
        listOf(
            ...
            ::setupValidLocationTrack to api.locationTrackElementListing::getWithExpectedError,
    ...
    private val modificationErrorTests =
        listOf(
            ...
            ::setupValidLocationTrack to api.locationTrackElementListing::getModifiedWithExpectedError,
    ...
    private val noContentTests =
        listOf(
            ...
            ::setupValidLocationTrack to api.locationTrackElementListing::getWithEmptyBody,
    ...
    private val noContentModificationTests =
        listOf(
            ...
            ::setupValidLocationTrack to api.locationTrackElementListing::getModifiedWithEmptyBody,
    ...
    private val modificationSuccessTests =
        listOf(
            ...
            ::setupValidLocationTrack to api.locationTrackElementListing::getModified,
