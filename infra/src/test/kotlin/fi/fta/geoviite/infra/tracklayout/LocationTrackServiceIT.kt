...
constructor(
    ...
    fun `overlapping plan search cropping works correctly in different edge cases`() {
        ...
        // TODO: Same as above, remove segments with "_2" in their names after GVT-3040 has been done
        val a1_1 = geometryAlignment(line(Point(0.0, 0.0), Point(2000.0, 0.0)))
        val a1_2 = geometryAlignment(line(Point(0.0, 2.0), Point(2000.0, 2.0)))
        val a2_1 = geometryAlignment(line(Point(3000.0, 0.0), Point(4000.0, 0.0)))
        val a2_2 = geometryAlignment(line(Point(3000.0, 2.0), Point(4000.0, 2.0)))
