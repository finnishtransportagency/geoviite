...
class EspooTestData {
    companion object {
        ...
        const val GEOMETRY_PLAN_NAME = "Linking geometry plan"
        const val REFERENCE_LINE_1_NAME = "ESP1"
        const val REFERENCE_LINE_3_NAME = "ESP3"
        const val GEO_ALIGNMENT_A_NAME = "geo-alignment-a"
        const val GEO_ALIGNMENT_B_NAME = "geo-alignment-b"
        const val GEO_ALIGNMENT_C_NAME = "geo-alignment-c"
        const val GEO_ALIGNMENT_D_NAME = "geo-alignment-d"
        const val GEO_ALIGNMENT_E_NAME = "geo-alignment-e"
        const val GEO_ALIGNMENT_F_NAME = "geo-alignment-f"
        const val GEO_ALIGNMENT_I_NAME = "geo-alignment-i"
        ...
        const val BASE_POINT_X = 369800.00
        const val BASE_POINT_Y = 6676400.00
        ...
        fun geometryPlan(trackLayoutTrackNumberId: IntId<TrackLayoutTrackNumber>): GeometryPlan {
            ...
            val switchAndAlignments1 = createSwitchAndAlignments(
            ...
            val switchAndAlignments2 = createSwitchAndAlignments(
            ...
            return GeometryPlan(
                ...
                ).plus(switchAndAlignments1.second).plus(switchAndAlignments2.second),
        ...
        fun geometryKmPosts(trackNumberId: IntId<TrackLayoutTrackNumber>): List<GeometryKmPost> {
            val locations = listOf(
                Point(x = 100.0, y = 10.0), Point(x = 50.0, y = 20.0), Point(x = 50.0, y = 20.0)
            ...
            return locations.mapIndexed { index, location ->
                createGeometryKmPost(
                    trackNumberId, location, "000${index}GM"
                )
            }
        }

        fun trackLayoutKmPosts(trackNumberId: IntId<TrackLayoutTrackNumber>): List<TrackLayoutKmPost> {
            val locations = listOf(Point(x = 100.0, y = 20.0), Point(x = 50.0, y = 20.0)).scan(
                BASE_POINT + Point(
                    x = 0.0, y = 80.0
                )
            ) { prevPoint, pointIncr -> prevPoint + pointIncr }

            return locations.mapIndexed { index, location ->
                trackLayoutKmPost(
                    "000${index}LO", trackNumberId, location
                )
            }
        }

        fun geometryAlignmentA(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun locationTrackB(trackNumber: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "B",
        ...
        fun geometryAlignmentC(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun geometryAlignmentD(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun geometryAlignmentE(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun locationTrackE(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "E",
        ...
        fun geometryAlignmentF(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun locationTrackF(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "F",
            trackNumber = trackNumberId,
        ...
        fun geometryAlignmentI(trackNumberId: IntId<TrackLayoutTrackNumber>) = createGeometryAlignment(
        ...
        fun trackLayoutSwitchA(): TrackLayoutSwitch {
            ...
            return trackLayoutSwitch("switch-A",
                listOf(location),
                switchStructures.first { it.type.typeName == "YV60-300-1:9-O" })
        }

        fun locationTrackJ(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "J",
            trackNumber = trackNumberId,
        ...
        fun referenceLine1(trackNumber: IntId<TrackLayoutTrackNumber>): Pair<ReferenceLine, LayoutAlignment> {
            val points = pointsFromIncrementList(
                BASE_POINT + Point(x = -20.0, y = 5.0), listOf(Point(x = 140.0, y = 10.0), Point(x = 140.0, y = 10.0))
            )
        ...
        fun referenceLine2(trackNumber: IntId<TrackLayoutTrackNumber>): Pair<ReferenceLine, LayoutAlignment> {
            val points = pointsFromIncrementList(
                BASE_POINT + Point(x = 0.0, y = 0.0), listOf(Point(x = 15.0, y = 1.0), Point(x = 15.0, y = 1.0))
            )
        ...
        fun referenceLine3(trackNumber: IntId<TrackLayoutTrackNumber>): Pair<ReferenceLine, LayoutAlignment> {
            val points = pointsFromIncrementList(
                BASE_POINT + Point(x = -20.0, y = 10.0),
                listOf(Point(x = 15 + .0, y = 10.0), Point(x = 150.0, y = 10.0))
            )
