...
constructor(
    ...
    fun `Split can be created and published`() {
        ...
        val trackNumberId =
            mainOfficialContext.createLayoutTrackNumber(trackNumber, referenceLineGeometry(geometry.segments)).id
        ...
        assertTrue(
            getElementWhenExists(byQaId("start-splitting")).isEnabled,
            "splitting a target track again should be possible after manually allowing to edit the track",
        )
    }
}
