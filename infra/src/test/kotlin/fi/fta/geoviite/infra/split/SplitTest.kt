...
private fun assertSplitResultFields(track: LocationTrack, request: SplitRequestTarget, result: SplitTargetResult) {
    ...
    assertEquals(request.namingScheme, result.locationTrack.nameStructure.scheme)
    assertEquals(request.nameFreeText, result.locationTrack.nameStructure.freeText)
    assertEquals(request.nameSpecifier, result.locationTrack.nameStructure.specifier)
    assertEquals(request.descriptionBase, result.locationTrack.descriptionStructure.base)
    assertEquals(request.descriptionSuffix, result.locationTrack.descriptionStructure.suffix)
