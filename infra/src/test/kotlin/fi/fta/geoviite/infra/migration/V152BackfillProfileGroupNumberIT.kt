...
@Autowired
constructor(val geometryDao: GeometryDao, val dataSource: DataSource) : DBTestBase() {
    ...
    private fun fetchProfileGroupNumber(planId: IntId<GeometryPlan>): String? =
        jdbc
            .query(
                ...
                rs.getString("profile_group_number")
            }
            .single()

    private fun profileWithoutGroupNumber(name: String) =
        GeometryProfile(
