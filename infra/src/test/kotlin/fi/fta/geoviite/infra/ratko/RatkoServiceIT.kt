...
class RatkoServiceIT @Autowired constructor(
    ...
    fun pushSwitch() {
        ...
        assertEquals(5f, switchLocations[0].nodecollection.nodes[0].point.kmM.meters.toFloat())
        assertEquals(RatkoNodeType.JOINT_A, switchLocations[0].nodecollection.nodes[0].nodeType)
        assertEquals(7.5f, switchLocations[1].nodecollection.nodes[0].point.kmM.meters.toFloat())
        assertEquals(RatkoNodeType.JOINT_C, switchLocations[1].nodecollection.nodes[0].nodeType)

        assertEquals("1.2.3.4.5", switchLocations[0].nodecollection.nodes[0].point.locationtrack!!.toString())
        assertEquals("2.3.4.5.6", switchLocations[1].nodecollection.nodes[0].point.locationtrack!!.toString())
        assertEquals(
