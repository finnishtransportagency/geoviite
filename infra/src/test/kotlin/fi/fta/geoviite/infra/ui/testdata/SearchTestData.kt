...
class SearchTestData {
    companion object {
        ...
        fun createLocationTrackHkiA(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "LT-A HKI",
        ...
        fun createLocationTrackHkiB(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "LT-B HKI",
            trackNumber = trackNumberId,
        ...
        fun createLocationTrackEspA(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "LT-A ESP 1",
            trackNumber = trackNumberId,
        ...
        fun createLocationTrackEspB(trackNumberId: IntId<TrackLayoutTrackNumber>) = locationTrack(
            name = "LT-B ESP 2",
            trackNumber = trackNumberId,
