...
class FrozenMigrationsTest @Autowired constructor(
    ...
    fun initMigrationsHaveNotChanged() {
        ...
        val expectedMigrations: List<MigrationFile> = listOf(
            ...
            MigrationFile(fileName = "V00.10__utility_functions.sql", checksum = 1115603267),
            MigrationFile(fileName = "V00.11__metadata_functions.sql", checksum = 1301034460),
            ...
            MigrationFile(fileName = "V03.05.01__location_track.sql", checksum = -928786530),
            MigrationFile(fileName = "V03.05.02__reference_line.sql", checksum = 1815023431),
            ...
            MigrationFile(fileName = "V10.03.04__switch_owner_values.sql", checksum = 1821224761),
            MigrationFile(fileName = "V10.04.01__triangulation_network.sql", checksum = -179975057),
            MigrationFile(fileName = "V10.04.02__inserts_for_triangle_corner_point_table.sql", checksum = -1836563717),
            MigrationFile(fileName = "V10.04.03__inserts_for_triangulation_network_table.sql", checksum = 2004535495),
            MigrationFile(
                fileName = "V10.04.04__inserts_for_kkj_etrs_triangle_corner_point_table.sql",
                checksum = -294904538
            ),
            MigrationFile(fileName = "V10.04.05__inserts_for_kkj_etrs_triangulation_network.sql", checksum = 571127275),
            MigrationFile(fileName = "V11.00.00__track_number_imports_in_code.sql", checksum = 465780583),
            MigrationFile(fileName = "V12.00.00__inframodel_imports_in_code.sql", checksum = 1765353731),
            ...
            MigrationFile(fileName = "V17.02.00__add_first_publication.sql", checksum = -1157951969),
        )
