...
class FrozenMigrationsTest @Autowired constructor(
    ...
    fun initMigrationsHaveNotChanged() {
        ...
        val expectedMigrations: List<MigrationFile> = listOf(
            ...
            MigrationFile(fileName = "V10.04.01__common_n60_n200_triangulation_network.sql", checksum = -179975057),
            MigrationFile(fileName = "V10.04.02__common_inserts_for_n60_n2000_triangle_corner_point_table.sql", checksum = -1836563717),
            MigrationFile(fileName = "V10.04.03__common_inserts_for_n60_n2000_triangulation_network_table.sql", checksum = 2004535495),
            MigrationFile(
