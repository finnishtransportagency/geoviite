ARG IMAGE_BASE_BACKEND_BUILD=public.ecr.aws/docker/library/eclipse-temurin:17-jdk-noble
ARG IMAGE_BASE_FRONTEND_BUILD=public.ecr.aws/docker/library/node:22-alpine
ARG IMAGE_BASE_DISTRIBUTION=public.ecr.aws/docker/library/eclipse-temurin:17-jre-noble
