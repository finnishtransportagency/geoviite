import { API_URI, getNonNull, Page, postNonNull, queryParams } from 'api/api-fetch';
import {
    CalculatedChanges,
    DraftChangeType,
...
export const revertPublicationCandidates = (
    ...
    return postNonNull<PublicationRequestIds, PublicationRequestIds>(
        `${publicationUri(layoutBranch)}/candidates/revert-request`,
        toPublicationRequestIds(candidates),
    );
};
