...
export const topologicalConnectivityTypes: {
    value: TopologicalConnectivityType;
    name: () => string;
}[] = [
...
export const planPhases: { value: PlanPhase; name: () => string }[] = [
    ...
    {
        value: 'ENHANCED_RENOVATION_PLAN',
        name: () => i18n.t('enum.plan-phase.ENHANCED_RENOVATION_PLAN'),
    },
