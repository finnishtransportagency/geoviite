...
export function mergePartialItemSearchResults(
    ...
    return searchResults.reduce<LayerItemSearchResult>((merged, searchResult) => {
        return {
            ...
            operationalPointClusters: mergeOptionalArrays(
                merged.operationalPointClusters,
                searchResult.operationalPointClusters,
            ),
            ...
            operationalPointsHitByIcon: mergeOptionalArrays(
                merged.operationalPointsHitByIcon,
                searchResult.operationalPointsHitByIcon,
            ),
        };
    }, {});
}
