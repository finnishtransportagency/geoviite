...
async function getHoverLocationBySelection(coordinate: Point | null): Promise<HoverLocation> {
    const trackNumberIds = rootStore.getState().trackLayout.selection.selectedItems.trackNumbers;
    const locationTracks = rootStore.getState().trackLayout.selection.selectedItems.locationTracks;
    const publishType = rootStore.getState().trackLayout.publishType;
