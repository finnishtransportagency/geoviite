...
function getKmOptions(startAndEnd: LocationTrackStartAndEndPoints): Item<string>[] {
...
export const LocationTrackRatkoPushDialog: React.FC<LocationTrackRatkoPushDialogProps> = (
    ...
    async function pushToRatko() {
        if (locationTrack && startKm != undefined && endKm != undefined && !pushing) {
            try {
                setPushing(true);
                            ...
                            value={
                                <React.Fragment>
                                    <Dropdown
                                        ...
                                        options={kmOptions}
                                        onChange={(value) =>
                                            value != undefined && setStartKm(value)
                                        }
                                    ...
                                    <Dropdown
                                        value={endKm}
                                        options={kmOptions}
                                        onChange={(value) => value != undefined && setEndKm(value)}
                                        size={DropdownSize.SMALL}
                                    />
                                </React.Fragment>
                            }
