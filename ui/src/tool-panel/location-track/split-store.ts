...
type SplitTargetCandidateBase = {
    ...
    duplicateTrackId?: LocationTrackId;
    location: Point;
    // TODO: GVT-2525 replace this with type: new/overwrite_duplicate/transfer_targets
    new: boolean;
...
//                 duplicate.start.point.x,
//                 duplicate.start.point.y,
//                 otherPoint.x,
//                 otherPoint.y,
//             ),
//             duplicate: duplicate,
...
const findDuplicateStartingAt = (duplicates: SplitDuplicate[], switchId: LayoutSwitchId) => {
    console.log('seeking dup', switchId, duplicates);
    return duplicates.find((duplicate) => {
        console.log('checking', duplicate, switchId);
