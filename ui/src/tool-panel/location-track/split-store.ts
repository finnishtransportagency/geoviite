    ...
    onStartSplitting: (state: TrackLayoutState, { payload }: PayloadAction<SplitStart>): void => {
        ...
        if (locationTrackSelected) {
            ...
            const nameAndDesc =
                duplicateAtStart?.name === undefined
                    ...
                    : ({
                          ...
                          descriptionBase: duplicateAtStart.descriptionStructure.base ?? '',
            ...
            const firstSplit: FirstSplitTargetCandidate = {
                ...
                suffixMode: duplicateAtStart?.descriptionStructure.suffix ?? 'NONE',
...
function splitPointToSplitTargetCandidate(
    ...
    return {
        ...
        descriptionBase: duplicateAt?.descriptionStructure.base ?? '',
        suffixMode: duplicateAt?.descriptionStructure.suffix ?? 'NONE',
