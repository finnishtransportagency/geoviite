...
Kuvaukset järjestelmän tarkoituksesta, vaatimuksista ja projektinhallintaan liittyvistä asioista löytyy Geoviitteen
Confluencen puolelta.

Geoviitteen dokumentaatio säilytetään versionhallinnassa, koodin rinnalla markdown-formaatissa
...
* [Paikannuspohjan validointi](paikannuspohjan_validointi.md)
