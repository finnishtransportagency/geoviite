...
- plan
    ...
    - Explain
        ...
        - How new behavior is tested with unit and/or integration tests
- red
    - Write unit and integration tests for currently selected feature by the implementation plan
    - Modify current structures (classes, function signatures etc.) so that tests can be run, but behavior must *not* be
      modified at this point
    - Ensure that new tests are failing because assertions
- green
    - Implement behavior of currently selected feature by the implementation plan
    ...
    - Make sure tests written for this feature succeed
